 ...
 */
public class ListAdapterIconDialog  extends ArrayAdapter<String> {

    private List<Integer> images;

    public ListAdapterIconDialog(Context context, List<String> items, List<Integer> images) {
        super(context, android.R.layout.select_dialog_item, items);
        this.images = images;
    }

    public ListAdapterIconDialog(Context context, String[] items, Integer[] images) {
        super(context, android.R.layout.select_dialog_item, items);
        this.images = Arrays.asList(images);
    }

    public ListAdapterIconDialog(Context context, int items, int images) {
