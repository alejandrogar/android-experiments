...
public class img_slider extends AppCompatActivity {
    ...
    NetworkUtils utils = new NetworkUtils(img_slider.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataSlide = (TextView) findViewById(R.id.data_slide);
    ...
    private void init() {
        ...
        mPager.setAdapter(new ImageAdapter(img_slider.this,ImagesUrlArray));
...
//Set circle indicator radius
        ...
        indicator.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int pos, float arg1, int arg2) {
                //Log.i("POSITION",""+arg1);
                dataSlide.setText("Position slide -> "+arg1);
            }
